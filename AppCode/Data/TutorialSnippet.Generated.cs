...
namespace AppCode.Data
{
  ...
  /// Most properties have a simple access, such as `.AddOns`. <br/>
...
{
  /// <summary>
  /// Auto-Generated *base* class for 'TutorialSnippet' in scope 'Default'. It uses special names to avoid accidental use.
  /// </summary>
  public abstract class ZAutoGenTutorialSnippet: Custom.Data.CustomItem
  {
    /// <summary>
    /// AddOns as list of TutorialSnippetAddOn.
    /// </summary>
    /// <remarks>
    /// Generated to return child-list child because field settings had Multi-Value=true. The type TutorialSnippetAddOn was specified in the field settings.
    /// </remarks>
    /// <returns>
    /// An IEnumerable of specified type, but can be empty.
    /// </returns>
    public IEnumerable<TutorialSnippetAddOn> AddOns => _addOns ??= _item.Children<TutorialSnippetAddOn>("AddOns");
    private IEnumerable<TutorialSnippetAddOn> _addOns;
    ...
    /// <summary>
    /// PageShieldUrlParameters as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("PageShieldUrlParameters", scrubHtml: true) etc.
    /// </summary>
    public string PageShieldUrlParameters => _item.String("PageShieldUrlParameters", fallback: "");
